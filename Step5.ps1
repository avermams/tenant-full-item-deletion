            ...
            do {
                ...
                while ($true) {
                    ...
                    try {
                        ...
                        Write-Host "Throttled, waiting $retryAfterSeconds seconds before retrying to get workspace items"
                ...
                if ($skipWorkspace -eq $true) {
                    Write-Warning "Skipping workspace $wsId due to failure in retrieving its content"
                    break
                }
